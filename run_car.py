...
Train model from the beginning
    python3 run_car.py -s 800 --seed 13

Continue model training
    python3 run_car.py -s 800 --seed 13 -f weights.txt

Evaluate model:
    python3 run_car.py -s 800 --seed 13 -f weights.txt -e True
